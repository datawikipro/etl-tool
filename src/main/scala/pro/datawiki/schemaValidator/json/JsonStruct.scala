...
import pro.datawiki.schemaValidator.json.jsonConfig.{JsonSchemaArray, JsonSchemaBoolean, JsonSchemaDouble, JsonSchemaInt, JsonSchemaNull, JsonSchemaObject, JsonSchemaString}
