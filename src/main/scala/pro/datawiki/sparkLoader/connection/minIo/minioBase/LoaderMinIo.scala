  ...
  val minioClient: MinioClient = {
    ...
    if (disableCertChecking) {
      val trustAllCerts = Array[javax.net.ssl.TrustManager](new javax.net.ssl.X509TrustManager {
        ...
        def getAcceptedIssuers(): Array[java.security.cert.X509Certificate] = Array()
      })
      ...
      val httpClient = new okhttp3.OkHttpClient.Builder()
        .sslSocketFactory(sslSocketFactory, trustAllCerts(0).asInstanceOf[javax.net.ssl.X509TrustManager])
