...
lazy val schemaValidator = (project in file("libs/schema-validator"))
  .settings(
...
libraryDependencies ++= Seq(
  "org.apache.iceberg" % s"iceberg-spark-runtime-3.5_2.13" % icebergVersion,
)
...
run / javaOptions ++= Seq(
  ...
  "-Dhadoop.home.dir=C:\\Users\\chernousov_a",
  "-Dhadoop.security.group.mapping=org.apache.hadoop.security.NullGroupsMapping",
