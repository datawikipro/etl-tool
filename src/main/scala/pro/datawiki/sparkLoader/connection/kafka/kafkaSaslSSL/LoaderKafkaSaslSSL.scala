...
class LoaderKafkaSaslSSL(configYaml: YamlConfig) extends kafkaBase.LoaderKafka(kafkaBase.YamlConfig(`bootstrap.servers` = configYaml.`bootstrap.servers`)), ConnectionTrait, QueryTrait {
