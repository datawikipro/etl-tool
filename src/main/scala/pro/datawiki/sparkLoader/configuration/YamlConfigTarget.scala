...
import pro.datawiki.sparkLoader.configuration.yamlConfigTarget.{YamlConfigTargetDatabase, YamlConfigTargetDummy, YamlConfigTargetFileSystem, YamlConfigTargetMessageBroker, YamlConfigTargetStdout}
...
case class YamlConfigTarget(database: YamlConfigTargetDatabase,
                            ...
                            stdout: YamlConfigTargetStdout,
                            ignoreError: Boolean
                           ) extends  LoggingTrait {
  @JsonIgnore
  def getLogic: YamlConfigTargetTrait = {
    LogicClass.getLogic(database, fileSystem, messageBroker, dummy, stdout) match
